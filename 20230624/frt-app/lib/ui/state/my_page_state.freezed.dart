...
class _$MyPageStateCopyWithImpl<$Res, $Val extends MyPageState>
  ...
  @override
  $Res call({
    Object? nanacoPoint = freezed,
  }) {
    return _then(_value.copyWith(
      nanacoPoint: freezed == nanacoPoint
          ? _value.nanacoPoint
...
class _$_MyPageState implements _MyPageState {
  _$_MyPageState({this.nanacoPoint});
  ...
  @override
  String toString() {
    return 'MyPageState(nanacoPoint: $nanacoPoint)';
  }
...
abstract class _MyPageState implements MyPageState {
  factory _MyPageState({final int? nanacoPoint}) = _$_MyPageState;
