...
part 'login_customer_model.freezed.dart';
part 'login_customer_model.g.dart';

@freezed
class LoginCustomerModel with BaseCustomerModel, _$LoginCustomerModel {
  const LoginCustomerModel._();

  @With<BaseCustomerModel>()
  const factory LoginCustomerModel({
    /// 初回利用登録トークン
    @JsonKey(ignore: true) String? firstUseToken,
    ...
    */
    ...
    /*
      初回利用登録済みフラグ
        ...
        ```
     */
    @Default(true) bool isFirstUseRegistered,
    /*
      購入不可商品あり判定
        ```
        true：商品あり
  ...
  factory LoginCustomerModel.fromJson(Map<String, dynamic> json) => _$LoginCustomerModelFromJson(json);
